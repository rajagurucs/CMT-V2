...
//User Register down
            ...
            //    $check = User::select('email')
                ...
                //    $birthDate = $request->birthDate;
                    $gender = $request->json()->get('gender');
                    $email = $request->json()->get('email');
                    $phone = $request->json()->get('phoneCell');
                    $password = $defaultpwd;
                    ...
                    Mail::send('email.verify', ['firstName' => $firstName, 'verification_code' => $verification_code],
                        ...
                        $Message = "IRF Completed and Verification Mail sent Sucessfully";
                    ...
                    //    $birthDate = $request->birthDate;
                        ...
                        $user2=User::where('email',$email1)
                                        ...
                                        $Message = "IRF Completed for the already registered User";
